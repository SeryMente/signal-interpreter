...
function handle(e){
  ...
  if(e.type==="uia.scan"){var bubble=Number(e.captionBubbles||0),views=Number(e.captionViews||0),nonEmpty=Number(e.nonEmptyViews||0);$("participantDetection").textContent="UIA: "+Number(e.chromeWindows||0)+" Chrome · "+bubble+" bubbles · "+views+" views · "+nonEmpty+" con texto";if(nonEmpty>0&&$("captionText").textContent!=="Activo")$("captionText").textContent="Caption detectado";return}
